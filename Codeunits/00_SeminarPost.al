codeunit 123456700 "Seminar-Post"
{
    ...
    begin
        ...
        with SeminarRegHeader do begin
            ...
            CopyCommentLines(SeminarCommentLine."Table Name"::"Seminar Registration Header", SeminarCommentLine."Table Name"::"Posted Seminar Regisstration Header", "No.",PstdSeminarRegHeader."No.");
